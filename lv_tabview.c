 ...
 **********************/
typedef struct {
    lv_coord_t grid_col_dsc[2];
    lv_coord_t grid_row_dsc[2];
    lv_grid_t grid;
    uint16_t tab_cnt;
    uint16_t tab_cur;
    lv_dir_t tab_pos;
...
lv_obj_t * lv_tabview_create(lv_obj_t * parent, lv_dir_t tab_pos, lv_coord_t tab_size)
{
    ...
    ext->grid.col_dsc = ext->grid_col_dsc;
    ext->grid.row_dsc = ext->grid_row_dsc;
    ext->tab_pos = tab_pos;

    switch(ext->tab_pos) {
    case LV_DIR_TOP:
        ext->grid_row_dsc[0] = tab_size;
        ext->grid_row_dsc[1] = LV_GRID_FR(1);
        ext->grid_col_dsc[0] = LV_GRID_FR(1);
        ext->grid.col_dsc_len = 1;
        ext->grid.row_dsc_len = 2;
        break;
    case LV_DIR_BOTTOM:
        ext->grid_row_dsc[0] = LV_GRID_FR(1);
        ext->grid_row_dsc[1] = tab_size;
        ext->grid_col_dsc[0] = LV_GRID_FR(1);
        ext->grid.col_dsc_len = 1;
        ext->grid.row_dsc_len = 2;
        break;
    case LV_DIR_LEFT:
        ext->grid_row_dsc[0] = LV_GRID_FR(1);
        ext->grid_col_dsc[0] = tab_size;
        ext->grid_col_dsc[1] = LV_GRID_FR(1);
        ext->grid.col_dsc_len = 2;
        ext->grid.row_dsc_len = 1;
        break;
    case LV_DIR_RIGHT:
        ext->grid_row_dsc[0] = LV_GRID_FR(1);
        ext->grid_col_dsc[0] = LV_GRID_FR(1);
        ext->grid_col_dsc[1] = tab_size;
        ext->grid.col_dsc_len = 2;
        ext->grid.row_dsc_len = 1;
        break;
    }
    ...
    lv_obj_set_grid(tabview, &ext->grid);

    lv_obj_t * btnm = lv_btnmatrix_create(tabview, NULL);
    ...
    lv_obj_t * cont = lv_obj_create(tabview, NULL);
    ...
    switch(ext->tab_pos) {
    case LV_DIR_TOP:
        lv_obj_set_pos(btnm, LV_GRID_CELL_STRETCH(0, 1), LV_GRID_CELL_STRETCH(0, 1));
        lv_obj_set_pos(cont, LV_GRID_CELL_STRETCH(0, 1), LV_GRID_CELL_STRETCH(1, 1));
        break;
    case LV_DIR_BOTTOM:
        lv_obj_set_pos(btnm, LV_GRID_CELL_STRETCH(0, 1), LV_GRID_CELL_STRETCH(1, 1));
        lv_obj_set_pos(cont, LV_GRID_CELL_STRETCH(0, 1), LV_GRID_CELL_STRETCH(0, 1));
        break;
    case LV_DIR_LEFT:
        lv_obj_set_pos(btnm, LV_GRID_CELL_STRETCH(0, 1), LV_GRID_CELL_STRETCH(0, 1));
        lv_obj_set_pos(cont, LV_GRID_CELL_STRETCH(1, 1), LV_GRID_CELL_STRETCH(0, 1));
        break;
    case LV_DIR_RIGHT:
        lv_obj_set_pos(btnm, LV_GRID_CELL_STRETCH(1, 1), LV_GRID_CELL_STRETCH(0, 1));
        lv_obj_set_pos(cont, LV_GRID_CELL_STRETCH(0, 1), LV_GRID_CELL_STRETCH(0, 1));
        break;
    }
    static lv_grid_t grid_row;

    static lv_coord_t grid_row_row_dsc[] = {LV_GRID_FR(1)};
    static lv_coord_t grid_row_col_dsc[] = {LV_GRID_REPEAT_FIT};
    _lv_memset_00(&grid_row, sizeof(grid_row));
    grid_row.row_dsc =  grid_row_row_dsc;
    grid_row.row_dsc_len = 1;
    grid_row.col_dsc =  grid_row_col_dsc;
    grid_row.col_dsc_len = 1;

    lv_obj_set_grid(cont, &grid_row);
...
lv_obj_t * lv_tabview_add_tab(lv_obj_t * tv, const char * name)
{
    ...
    lv_obj_set_pos(tab, LV_GRID_CELL_STRETCH(tab_id - 1, 1), LV_GRID_CELL_STRETCH(0, 1));

    lv_obj_t * btns = lv_tabview_get_tab_btns(tv);

    const char ** old_map = lv_btnmatrix_get_map_array(btns);
        const char ** new_map;
    if(ext->tab_pos & LV_DIR_VER) {
